...
for area in areas:
    ...
    fig.add_trace(go.Scatter(x=area_data[0], y=area_data[1], mode="lines", name=area))
fig.update_traces(line_shape="hv", selector=dict(type="scatter"))
fig.update_layout(title="EL spot priser", xaxis_title="CEST", yaxis_title="NOK/MWh")
fig.write_html("historisk.html")
# fig.write_image('historisk.png', width=1920, height=1080)
